...
class PlotConfigurationBuilder:
    ...
    def build(self) -> PlotConfiguration:
        ...
        """
        return PlotConfiguration(**self._plot_config)
...
class PlotConfigurationParser:
    ...
    def __init__(self, builder: PlotConfigurationBuilder, plot_configuration):
        ...
        self.plot_config = plot_configuration
    ...
    def parse(self) -> PlotConfiguration:
        ...
        """
        if self.plot_config:
            self.builder = YamlParser(self.plot_config).parse_config(self.builder)
        else:
            self.builder = InteractiveParser().parse_config(self.builder)
