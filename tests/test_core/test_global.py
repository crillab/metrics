...
class MyTestCase(unittest.TestCase):
    ...
    def test_equalities(self):
        ...
        self.assertEqual(self.campaign.input_set.inputs[0].path, '/home/cril/wattez/XCSP17/SuperSolutions/SuperSolutions-Taillard-os04/SuperTaillard-os-04-26.xml.lzma')
        self.assertEqual(self.campaign.input_set.inputs[0].family, 'SuperSolutions')
        self.assertEqual(self.campaign.input_set.inputs[-1].path, '/home/cril/wattez/XCSP17/Wwtpp/Wwtpp-ord-s1/Wwtpp-ord-ex08540.xml.lzma')
